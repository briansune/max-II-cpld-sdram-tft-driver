...
#ifndef __CPLD_CTRL_H
#define __CPLD_CTRL_H
...
void LCE_RD_DATA_INIT(void);
void LCE_WR_DATA_INIT(void);

void LCD_WR_DATA_unroll_128(uint16_t LCD_RegValue);
...
uint16_t LCD_read_cmd_data(uint16_t cmd);
